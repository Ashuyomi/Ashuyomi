...
class EHentaiUpdateWorker : JobService(), CoroutineScope {
    ...
    companion object {
        ...
        private val MIN_BACKGROUND_UPDATE_FREQ = 1.days.inMilliseconds.roundToLong()
        ...
        fun scheduleBackground(context: Context, prefInterval: Int? = null) {
            ...
            if (duration > 0) {
                ...
                val jobInfo = context.periodicBackgroundJobInfo(
                    duration.hours.inMilliseconds.roundToLong(),
                    acRestriction,
                    wifiRestriction
                )
...
object EHentaiUpdateWorkerConstants {
    ...
    @OptIn(ExperimentalTime::class)
    val GALLERY_AGE_TIME = 365.days.inMilliseconds.roundToLong()
}
